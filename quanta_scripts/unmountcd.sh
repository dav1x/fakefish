...
# Disconnect image
curl -X POST -H 'Content-Type: application/json' -sk -u ''"${BMC_USERNAME}"'':''"${BMC_PASSWORD}"'' -d "{}" https://${BMC_ENDPOINT}/redfish/v1/Managers/BMC_0/VirtualMedia/CD1/Actions/VirtualMedia.EjectMedia 
sleep 2
if [ $? -eq 0 ]; then
